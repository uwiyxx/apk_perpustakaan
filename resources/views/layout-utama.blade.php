...
<body>
    ...
    <div id="main" class="main d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-dark bg-light"
            style="width: 280px; height:calc(100vh - 58px);">
            <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle"
                id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="\image\icons8-user-24.png" alt="" width="32" height="32"
                    class="rounded-circle me-2">
                <strong>Siti Nurcahya Dewi</strong>
            </a>
        ...
        <div id="isi-kontent" style="width: 100%; max-widh: calc(100% - 280px)" class="container-fluid mt-3">
            @yield('konten-utama')
        </div>
